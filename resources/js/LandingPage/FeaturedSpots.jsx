      ...
      <div className="relative z-20 p-4 sm:p-6 md:p-8 lg:p-10 w-full max-w-md md:max-w-lg lg:max-w-xl h-auto min-h-[400px] flex flex-col gap-2 justify-end">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="/login-select">
            <button className="font-Manbold rounded-3xl bg-accent text-white hover:bg-blue-900 transition-all inline-flex justify-center text-sm py-3 px-6 active:scale-[0.98] duration-75">
              {button}
            </button>
          </Link>
        </div>
